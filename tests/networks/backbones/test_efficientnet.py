...
class EfficientNetTestCase(unittest.TestCase):
    ...
    def test_efficientnet_b0(self):
        ...
        net = EfficientNet('efficientnet-b0', num_classes=2, in_channels=1)
    ...
    def test_efficientnet_b4(self):
        ...
        net = EfficientNet('efficientnet-b4', num_classes=2, in_channels=1)
        dummy = torch.ones((128, 1, 96, 64))
        out = net(dummy)
        self.assertTrue(out.shape, (128, 2))
    ...
    def test_efficientnet_b5(self):
        ...
        net = EfficientNet('efficientnet-b5', num_classes=2, in_channels=1)
        dummy = torch.ones((128, 1, 96, 64))
        out = net(dummy)
        self.assertTrue(out.shape, (128, 2))
    ...
    def test_efficientnet_b7(self):
        ...
        net = EfficientNet('efficientnet-b7', num_classes=2, in_channels=1)
        dummy = torch.ones((128, 1, 96, 64))
        out = net(dummy)
        self.assertTrue(out.shape, (128, 2))
